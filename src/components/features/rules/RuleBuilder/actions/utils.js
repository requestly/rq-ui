...
const appMode = GLOBAL_CONSTANTS.APP_MODES.DESKTOP;
...
export const createResponseRule = (source_url, response_body) => {
...
export const updateResponseRule = (rule_id, source_url, response_body) => {
  const rule_type = GLOBAL_CONSTANTS.RULE_TYPES.RESPONSE;
