...
import {
  ...
  getUpdateCurrentlySelectedRuleConfigActionObject,
  getClearCurrentlySelectedRuleAndConfigActionObject,
...
export const setCurrentlySelectedRule = (dispatch, newRule) => {
...
export const setCurrentlySelectedRuleConfig = (dispatch, config, navigate) => {
  if (config === undefined) {
    ...
    dispatch(getUpdateCurrentlySelectedRuleConfigActionObject(config));
  }
};
