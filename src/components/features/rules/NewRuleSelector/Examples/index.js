...
import { trackNewRuleSelectorExampleUseCaseClicked } from "utils/analytics/rules/new_rule_selector_example_usecase";
        ...
        <div>
          ...
          <div style={{ textAlign: "right" }}>
            <Button
              ...
              size="small"
              onClick={() => {
                trackNewRuleSelectorExampleUseCaseClicked(ruleType);
                window.open(
