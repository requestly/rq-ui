...
//UTILS
import { submitEventUtil } from "./AnalyticsUtils";
...
const getTimeDifferenceFromTimestamps = (time1, time2) => {
  ...
  return getAllRulesAndGroups(appMode).then((backupData) => {
    ...
    return updateRulesBackup({
      ...
      submitEventUtil(
        ...
        TRACKING.ACTIONS.BACKUP_CREATED,
        `rules and groups backup created`
      );
